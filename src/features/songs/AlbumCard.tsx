...
export function AlbumCard({ albumId, name, coverartUrl }: AlbumCardProps) {
  ...
  return (
    ...
    >
      ...
      <p className="shrink-0 text-slate-200 wrap-text">{name}</p>
    </div>
  );
}
